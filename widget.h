...
public:
    ...
    MPolygon getThorPoly(float a, float b, float c, const MMatrix4D &M);
    MPolygon getSpherePoly(float a, float b, float c, const MMatrix4D &M);
    void drawCoordinateSystem(QPainter &p, MMatrix4D &M);
    MPolygon getParabPoly(float a, float b, float c, float e, const MMatrix4D &M);
    ...
    void changeVisiblyRGB(bool bl);
    void changeVisiblyCoTr(bool bl);
    void changeVisiblyBlFg(bool bl);
